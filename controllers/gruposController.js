...
exports.formEditarGrupo = async (req, res) => {
    ...
    // Promise con await (para consultas que son independientes,
...
//Muestra el formulari para editar una imagen de grupo
...
exports.editarImagen = async (req, res, next) => {
    ...
    // revisar que existe el archivo anterior
    //if(grupo.imagen) {
...
exports.eliminarGrupo = async (req, res, next ) => {
    ...
    req.flash('exito', 'Grupo Eliinado');
    res.redirect('/administracion');
}