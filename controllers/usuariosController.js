...
// muestra el form para modificar el password
...
exports.cambiarPassword = async (req, res, next) => {
    ...
    // verificar que el pwd actual es correcto
    ...
    // si el password es correcto hasehar el nuevo
    const hash = usuario.hashPassword(req.body.nuevo);

    // asignar el pwd hasheado al usuario
...
// guarda la imagen nueva, elimina la anterior ( si aplica) y guarda 
